...
@Service
public class ImagenPromocionServiceImp extends BaseServiceImp<ImagenPromocion, Long> implements ImagenPromocionService {
    @Autowired
    ...
    @Override
    public List<ImagenPromocion> uploadImages(MultipartFile[] files) {
        List<String> urls = new ArrayList<>();
        List<Long> ids = new ArrayList<>();
        List<ImagenPromocion> imagenes = new ArrayList<>();
        try {
